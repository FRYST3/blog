        ...
        <div class="article__page_main">
            <form method="POST" action="/admin/article/new">
                ...
                <div class="article__review_input_wr">
                    ...
                    <input class="article__review_input" type="text" name="title" required>
                </div>
                <div class="article__review_input_wr">
                    <div class="article__review_input_label">Link Photo</div>
                    <input class="article__review_input" type="text" name="img" required>
                </div>
                <div class="article__review_input_wr">
                    <div class="article__review_input_label">Description</div>
                    <textarea class="article__review_input" name="desc" style="min-height: 200px; max-width: 100%;" required></textarea>
                </div>
                <div class="article__review_input_wr">
                    <div class="article__review_input_label">Text</div>
                    <textarea class="article__review_input" name="text" style="min-height: 300px; max-width: 100%;" required></textarea>
                </div>
                <div class="article__review_addbtn" style="justify-content: flex-start">
                    <button type="submit" class="article__review_btn">New</button>
                </div>
            </form>
        </div>
    </div>
